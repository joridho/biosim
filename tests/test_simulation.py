...
def test_num_animals_per_species(eg_sim2):
    """
    Testing if number of herbivores is 50 and number of carnivores is 0
    """
    b = eg_sim2
    num_per = b.num_animals_per_species
    assert [num_per["Herbivore"], num_per["Carnivore"]] == [50, 0]
